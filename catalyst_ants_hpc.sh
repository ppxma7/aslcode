...
export FAIR_DIR=/home/ppzma/gbperm01/FAIR2000_aslpp/
...
--metric CC[${SUBJECTS_DIR}/sub01_brain_mni.nii.gz,${DATA_DIR}/${FAIR_DIR}/diffav.nii.gz,0.7,32,Regular,0.1] \
--convergence [1000x500,1e-6,10] \
--shrink-factors 2x1 \
--smoothing-sigmas 1x0vox \
--transform Affine[0.1] \
--metric MI[${SUBJECTS_DIR}/sub01_brain_mni.nii.gz,${DATA_DIR}/${FAIR_DIR}/diffav.nii.gz,0.7,32,Regular,0.1] \
--convergence [1000x500,1e-6,10] \
--shrink-factors 2x1 \
--smoothing-sigmas 1x0vox \
--transform SyN[0.1,2,0] \
--metric CC[${SUBJECTS_DIR}/sub01_brain_mni.nii.gz,${DATA_DIR}/${FAIR_DIR}/diffav.nii.gz,1,2] \
